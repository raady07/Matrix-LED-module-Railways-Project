...
/*
*********************************************************************************************************
*                                     LIBRARY MEMORY POOL ERROR CODES
*********************************************************************************************************
*/

#define  LIB_MEM_ERR_NULL_PTR                          10001    /* Ptr  arg(s) passed NULL ptr(s).                      */
#define  LIB_MEM_ERR_INVALID_NBR                       10002    /* Invalid block number                                 */
#define  LIB_MEM_ERR_INVALID_BLK_SIZE                  10003    /* Invalid block size                                   */
#define  LIB_MEM_ERR_INVALID_SEG_SIZE                  10004    /* Invalid memory segment size                          */
#define  LIB_MEM_ERR_INVALID_ADDR                      10005    /* Invalid address passed to function                   */
#define  LIB_MEM_ERR_INVALID_POOL                      10006    /* Invalid or corrupted pool passed to function         */
#define  LIB_MEM_ERR_INVALID_IX                        10007    /* Invalid index in pool stack                          */

#define  LIB_MEM_ERR_NONE_AVAIL                        10010    /* None memory blocks available on memory pool          */
#define  LIB_MEM_ERR_POOL_FULL                         10011    /* Memory pool stack cannot hold more memory blocks     */

#define  LIB_MEM_ERR_SEG_OVERLAP                       10020    /* New segment overlaps previously defined segment      */
#define  LIB_MEM_ERR_SEG_FULL                          10021    /* Segment does not have more space available           */

#define  LIB_MEM_ERR_HEAP_NOT_FOUND                    10030    /* Heap segment could not be found in pool table        */
#define  LIB_MEM_ERR_HEAP_FULL                         10031    /* Heap segment does not have more space available      */
