...
//#define SWRESET_TIME 15
	
/*
*********************************************************************************************************
*                                             PIN CONFIGURATION w.r.t App
*********************************************************************************************************
*/
	
#define	DDR_EN_PHASE_R	TRISDbits.TRISD11	
#define	DDR_EN_PHASE_Y	TRISDbits.TRISD14 	
#define	DDR_EN_PHASE_B	TRISDbits.TRISD15 	


#define	EN_PHASE_R	LATDbits.LATD11 
#define	EN_PHASE_Y	LATDbits.LATD14 
#define	EN_PHASE_B	LATDbits.LATD15 	
...
void        Controller_IntEn(CPU_INT08U IntCont, CPU_INT08U IntNum, CPU_INT08U IntPol, CPU_INT08U IntAct, PFNCT pfnct);
void        Controller_IntDis(CPU_INT08U IntCont, CPU_INT08U IntNum);
void        Controller_IntDisAll(void);

CPU_INT32U  Controller_ClkFrq(void);
