...
*                        ptos - 40  ->  W1
*                        ptos - 44  ->  p_arg
*                        ptos - 46  ->   0 (15..8) | CORCON.7 | PC (22..16)      Simulate ISR
*                        ptos - 48  ->  PC (15..0)
*                        ptos - 50  ->  PC (22..16)                              Simulate function call
*                        ptos - 52  ->  PC (15..0)
*********************************************************************************************************
*/
...
OS_STK *OSTaskStkInit(  void (*task)(void *pd), void *p_arg, OS_STK *ptos, INT16U opt) {
   ...
   *ptos++  = (OS_STK)p_arg;                                            /* Initialize register W0                                   */
   ...
   *ptos++  = TBLPAG;                                                   /* Push the Data Table Page Address on to the stack         */
   *ptos++  = PSVPAG;                                                   /* Push the Program Space Visability Register on the stack  */
   *ptos++  = RCOUNT;                                                   /* Push the Repeat Loop Counter Register on to the stack    */
