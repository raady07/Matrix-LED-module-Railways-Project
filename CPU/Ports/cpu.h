...
#define  CPU_CFG_ADDR_SIZE              CPU_WORD_SIZE_16        /* Defines CPU address word size.                       */

#define  CPU_CFG_DATA_SIZE              CPU_WORD_SIZE_16        /* Defines CPU data    word size.                       */
...
typedef  CPU_INT16U  CPU_SR;                                    /* Defines   CPU status register size (see Note #3).    */
...
#define  CPU_CRITICAL_ENTER()           SRbits.IPL = 7
#define  CPU_CRITICAL_EXIT()            SRbits.IPL = 0
#endif

#if CPU_CFG_CRITICAL_METHOD == CPU_CRITICAL_METHOD_STATUS_LOCAL
#define  CPU_CRITICAL_ENTER()           {cpu_sr = SR; SRbits.IPL = 7;}
#define  CPU_CRITICAL_EXIT()            {SR = cpu_sr;}
#endif
